...
#Preview(as: .systemSmall) {
    ...
    SimpleEntry(date: .dayAfterChristmas!, holiday: createNewYearHolidayModel(newYearTimeInterval: DateComponents(calendar: .current, year: Date.currentYear + 1, month: 1, day: 1).date!.timeIntervalSince1970), background: BackgroundOption(id: .ChristmasBackground1, type: .image), text: TextOption(id: TextOptionId.ChristmasRed.rawValue))
